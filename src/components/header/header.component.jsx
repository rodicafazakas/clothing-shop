  ...
  return (
    <header className={`${COMPONENT} u-margin-bottom-medium`}>
      <div className={`${COMPONENT}__container`}>
        <aside className={`${COMPONENT}__sidenav`}>
          {!isMenuOpen && (
            <MenuBurger
              className={`${COMPONENT}__burger`}
        ...
        <ul className={`${COMPONENT}__list`}>
          <li className={`${COMPONENT}__item`}>
            <Link className={`${COMPONENT}__link`} to="/shop">
              Shop
            </Link>
          </li>
          {currentUser ? (
            <li className={`${COMPONENT}__item`}>
              <span className={`${COMPONENT}__link`} onClick={signOutUser}>
                SIGN OUT
              </span>
            </li>
          ) : (
            <li className={`${COMPONENT}__item`}>
              <Link className={`${COMPONENT}__link`} to="/auth">
                Sign in
              </Link>
            </li>
          )}
